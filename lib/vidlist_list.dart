...
import 'vidlist_form.dart';

import 'database/db_helper.dart';
import 'model/vidlist.dart';
                ...
                subtitle: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text("Tag Video: ${kontak.email}"),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(
                        top: 8,
                      ),
                      child: Text("Deskripsi Video: ${kontak.mobileNo}"),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(
                        top: 8,
                      ),
                      child: Text("Nama Uploader: ${kontak.company}"),
                    )
                  ],
                ),
                trailing: FittedBox(
                          ...
                          AlertDialog hapus = AlertDialog(
                            ...
                            content: Container(
                              ...
                              child: Column(
                                children: [
                                  Text(
                                      "Apakah anda yakin ingin menghapus data ${kontak.name}")
                                ],
                              ),
                            ),
                            //terdapat 2 button.
